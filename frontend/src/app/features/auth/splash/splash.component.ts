...
@Component({
  ...
  template: `
    <div class="splash-screen gradient-bg">
      ...
      <div class="splash-center animate-slide-up">
        ...
        <p class="app-tagline">Your <span class="highlight">zone</span>. Your <span class="highlight">vibe</span>. Your <span class="highlight">world</span>.</p>
      </div>
  ...
  styles: [`
    ...
    .btn-primary {
      ...
      box-shadow: 0 4px 20px rgba(116, 89, 247, 0.4);
      color: #000000;
    }
